...
move .\drawable-xhdpi\*.png %resourceFolder%\drawable-xhdpi
move .\drawable-xxhdpi\*.png %resourceFolder%\drawable-xxhdpi
move .\drawable-xxxhdpi\*.png %resourceFolder%\drawable-xxxhdpi
