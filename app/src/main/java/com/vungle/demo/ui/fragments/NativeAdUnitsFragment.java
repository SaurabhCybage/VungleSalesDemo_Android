 ...
 */
public class NativeAdUnitsFragment extends Fragment {

    public static final String AD_CATEGORY = "flexible-native-ads";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textViewAdHeaderTitle.setText("Flexible Native Ads");
